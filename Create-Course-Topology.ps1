...
{ 
            Write-host -ForegroundColor Yellow "Swtich name '$switch' ..."
    if($switch -eq "CIS-NAT-01"){
            Write-host -ForegroundColor Yellow "Creating Internal virtual switch $switch..."
            Write-host -ForegroundColor Yellow $line
            New-VMSwitch -Name CIS-NAT-01 -SwitchType Internal
            New-NetNat -Name CIS-NAT -InternalIPInterfaceAddressPrefix 10.1.1.0/24
            Get-NetAdapter -Name *NAT* | New-NetIPAddress -IPAddress 10.1.1.254 -PrefixLength 24
    } else 
    {
...
Create-VM -VMName SERVER -RAM 2GB -OS SVR2019G -Clone -switch CIS-NAT-01
Create-VM -VMName CLIENT1 -RAM 2GB -OS W8 -Clone -Switch CIS-NAT-01
Create-VM -VMName CLIENT2 -RAM 2GB -OS EmptyWin -Clone -Switch CIS-NAT-01
